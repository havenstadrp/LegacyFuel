...
Config.Strings = {
	ExitVehicle = "Verlaat het voertuig om te tanken",
	EToRefuel = "Druk op ~g~E~w~ om het voertuig bij te tanken",
	...
	CancelFuelingPump = "Druk op ~g~E~w~ om het tanken te annuleren",
	CancelFuelingJerryCan = "Druk op ~g~E~w~ om het tanken te annuleren",
	NotEnoughCash = "Niet genoeg geld",
	RefillJerryCan = "Druk op ~g~E~w~ om de jerrycan bij te vullen voor ~g~€",
	NotEnoughCashJerryCan = "Niet genoeg geld om jerrycan bij te vullen",
